    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <form id="filterForm" action="{{ route('laporan.surat') }}" method="GET">
            ...
            <div class="mt-4 flex justify-end">
                <button type="submit"
                    class="px-4 py-2 bg-green-500 text-white font-semibold rounded-md shadow-md hover:bg-green-600">
                    Filter
                </button>
                <a href="{{ route('laporan.surat') }}"
                    class="ml-2 px-4 py-2 bg-gray-500 text-white font-semibold rounded-md shadow-md hover:bg-gray-600">
                    Reset
                </a>
                <button type="button" onclick="cetakLaporan()"
                    class="ml-2 px-4 py-2 bg-red-500 text-white font-semibold rounded-md shadow-md hover:bg-red-600">
                    Cetak PDF
                </button>
            </div>
        </form>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase traacking-wider">Jenis
                            Surat</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($laporanSurat as $surat)
                        ...
                        @if($surat->status == 'Penting') bg-yellow-100 text-yellow-800
                        @elseif($surat->status == 'Rahasia') bg-red-100 text-red-800
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-gray-500">Tidak ada data surat yang ditemukan.
                            </td>
                        </tr>
                    @endforelse
                </tbody>

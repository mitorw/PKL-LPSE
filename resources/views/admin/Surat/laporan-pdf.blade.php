...
<body>
    ...
    <body>
            ...
            <table width="100%" style="border: none; border-collapse: collapse;">
                <tr>
                    <td width="15%" style="text-align:center; border:none;">
                        <img src="{{ public_path('logo-lampung.png') }}" alt="Logo" style="width:90px; height:auto;">
                    </td>
                ...
                @forelse($disposisiSurat as $sm)
                    <tr>
                        ...
                        @if ($sm->disposisis->count() > 0)
                            <td style="text-align:center;">Ada</td>
                            <td>
                                {{-- Menggabungkan semua nama bagian dengan koma --}}
                                {{ $sm->disposisis->pluck('dis_bagian')->implode(', ') }}
                            </td>
                            <td>
                                {{-- Mengambil catatan dari disposisi pertama (karena semuanya sama) --}}
                                {{ $sm->disposisis->first()->pivot->catatan ?? '-' }}
                            </td>
                            <td>
                                {{-- Mengambil instruksi dari disposisi pertama (karena semuanya sama) --}}
                                {{ $sm->disposisis->first()->pivot->instruksi ?? '-' }}
                            </td>
                        @else
                            <td style="text-align:center;">Tidak Ada</td>
                            <td>-</td>
        ...
        <div style="text-align:center; margin-top:20px;">
            <img src="data:image/png;base64,{{ $chartBase64 }}" alt="Pie Chart" style="width:300px; height:auto;">
